...
COPY ${bamboo.working.directory}/alpine-glibc/src/logicmonitor/cmd/container/APKBUILD .
COPY ${bamboo.working.directory}/alpine-glibc/src/logicmonitor/cmd/container/glibc.trigger .
COPY ${bamboo.working.directory}/alpine-glibc/src/logicmonitor/cmd/container/ld.so.conf .
COPY ${bamboo.working.directory}/alpine-glibc/src/logicmonitor/cmd/container/nsswitch.conf .
...
COPY ${bamboo.working.directory}/alpine-glibc/src/logicmonitor/cmd/container/abuilder .
